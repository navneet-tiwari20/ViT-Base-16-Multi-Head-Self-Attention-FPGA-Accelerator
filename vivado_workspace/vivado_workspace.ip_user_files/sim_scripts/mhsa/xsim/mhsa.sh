...
#
# Script generated by Vivado on Wed Aug 26 20:23:57 +0530 2026
...
#
# Usage        : mhsa.sh
#                mhsa.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mhsa.sh [-rerun]
#                mhsa.sh [-reset_run]
#                mhsa.sh [-clean]
#                mhsa.sh [-reset_log]
...
# script info
echo -e "mhsa.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mhsa.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L axi_utils_v2_0_11 -L xbip_pipe_v3_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_24 -L floating_point_v7_1_21 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mhsa xil_defaultlib.mhsa xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mhsa -key {Behavioral:sim_1:Functional:mhsa} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_e223.protoinst" -protoinst "protoinst_files/bd_2272.protoinst" -protoinst "protoinst_files/bd_2282.protoinst" -protoinst "protoinst_files/bd_e2d3.protoinst" -protoinst "protoinst_files/bd_2362.protoinst" -protoinst "protoinst_files/mhsa.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mhsa.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mhsa.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mhsa.sh [-help]\n\
Usage: mhsa.sh [-step]\n\
Usage: mhsa.sh [-lib_map_path]\n\
Usage: mhsa.sh [-rerun]\n\
Usage: mhsa.sh [-reset_run]\n\
Usage: mhsa.sh [-clean]\n\
Usage: mhsa.sh [-reset_log]\n\
Usage: mhsa.sh [-keep_index]\n\
Usage: mhsa.sh [-noclean_files]\n\n\
