...
// Command     : write_verilog -force -mode synth_stub -rename_top mhsa_smartconnect_0_0 -prefix
//               mhsa_smartconnect_0_0_ mhsa_smartconnect_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "mhsa_smartconnect_0_0,bd_e223,{}" *) (* CORE_GENERATION_INFO = "mhsa_smartconnect_0_0,bd_e223,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_e223,Vivado 2025.2" *) 
module mhsa_smartconnect_0_0(aclk, aresetn, S00_AXI_arid, S00_AXI_araddr, 
