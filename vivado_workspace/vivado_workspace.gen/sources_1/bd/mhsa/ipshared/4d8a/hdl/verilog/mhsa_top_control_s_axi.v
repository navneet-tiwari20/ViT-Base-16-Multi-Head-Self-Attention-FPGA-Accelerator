...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module mhsa_top_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_O_DATA_1     = 7'h38,
    ADDR_O_CTRL       = 7'h3c,
    ADDR_SCALE_DATA_0 = 7'h40,
    ADDR_SCALE_CTRL   = 7'h44,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_SCALE_DATA_0)
            int_scale[23:0] <= (WDATA[31:0] & wmask) | (int_scale[23:0] & ~wmask);
    end
end
