...
HD_PWD='C:/projects/vit_base16/vivado_workspace/vivado_workspace.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mhsa_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mhsa_wrapper.tcl
