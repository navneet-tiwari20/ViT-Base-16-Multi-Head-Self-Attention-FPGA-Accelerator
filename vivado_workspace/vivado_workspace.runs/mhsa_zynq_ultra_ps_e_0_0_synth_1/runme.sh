...
HD_PWD='C:/projects/vit_base16/vivado_workspace/vivado_workspace.runs/mhsa_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mhsa_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mhsa_zynq_ultra_ps_e_0_0.tcl
