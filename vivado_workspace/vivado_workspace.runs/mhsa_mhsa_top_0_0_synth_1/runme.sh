...
HD_PWD='C:/projects/vit_base16/vivado_workspace/vivado_workspace.runs/mhsa_mhsa_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mhsa_mhsa_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mhsa_mhsa_top_0_0.tcl
