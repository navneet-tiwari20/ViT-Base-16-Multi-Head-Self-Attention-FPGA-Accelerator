...
HD_PWD='C:/projects/vit_base16/vivado_workspace/vivado_workspace.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mhsa_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mhsa_wrapper.tcl -notrace
