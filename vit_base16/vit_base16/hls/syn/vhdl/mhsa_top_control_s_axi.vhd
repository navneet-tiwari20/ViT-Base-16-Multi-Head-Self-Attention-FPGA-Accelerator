...
entity mhsa_top_control_s_axi is
generic (
...
end entity mhsa_top_control_s_axi;
...
architecture behave of mhsa_top_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_SCALE_DATA_0 : INTEGER := 16#40#;
    constant ADDR_SCALE_CTRL   : INTEGER := 16#44#;
    ...
    signal int_scale           : UNSIGNED(23 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_SCALE_DATA_0 =>
                        rdata_data <= RESIZE(int_scale(23 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_scale(23 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SCALE_DATA_0) then
                    int_scale(23 downto 0) <= (UNSIGNED(WDATA(23 downto 0)) and wmask(23 downto 0)) or ((not wmask(23 downto 0)) and int_scale(23 downto 0));
                end if;
            end if;
        end if;
    end process;
